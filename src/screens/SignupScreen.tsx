    ...
    <FormPage>
      <View style={styles.body}>
        <View style={styles.header}>
          <Text style={styles.headline}>Create your New Here account! 🔑</Text>
          <Text style={styles.subhead}>
            Sign up to start dropping pins and exploring city secrets.
          </Text>
        </View>
        ...
        <Text style={styles.subhead}>Use at least 8 characters for your password.</Text>
        <PrimaryButton label={loading? "Creating Account..." : "Create account"} disabled={loading} onPress={() => onSubmit(email, password)} />
      ...
      <View style={styles.footer}>
        <Text style={styles.toggleText}>
          Already Have An Account? <Text style={styles.toggleLink} onPress={() => router.replace("/(auth)/login")}>Login</Text>
        </Text>
      </View>
    </FormPage>
  );
